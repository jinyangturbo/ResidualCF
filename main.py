...
def main():
    ...
    model = NMF.Model(input_user, input_item, output, num_users, num_items, layers, MLP=True)
    ...
    for epoch in xrange(epochs):
        ...
        if epoch % verbose == 0:
            ...
            if (hr + ndcg) / 2. > (best_hr + best_ndcg) / 2.:
                ...
                if args.out > 0:
                    save_path = saver.save(sess, "/Dataset/weiyu/Pretrain/MLP_%s_embeddings" % args.dataset)
